 ...
 * @author zaytona
 */
public class DocAddmedController implements Initializable {

    @FXML
    private TextField medID;
    @FXML
    private TextField medN;
    @FXML
    private TextField Eff;
...
@FXML
    ...
    private void add_butt(ActionEvent event) {
        try { 
            if (this.Eff.getText().isEmpty()|| this.medID.getText().isEmpty() || this.medN.getText().isEmpty()){
            ...
            try (Connection con = DriverManager.getConnection(url,"C##SuraS","11819597")) {
                ...
                String insQury = "INSERT INTO \"C##SURAS\".\"MEDICIEN\" (MED_ID, MED_NAME, EFFICT_SIDE) VALUES("+"'"+this.medID.getText()+"'"+", '"+this.medN.getText()+"'"+", '"+this.Eff.getText()+"')";
